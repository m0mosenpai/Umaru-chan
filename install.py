...
with cd("source"):
	...
	with cd("data"):
		...
		quality = input("What do you want the default quality of downloads to be? (720p/1080p):\n")
		...
		print("\033[96m[*] Add anime to your watchlist by running client.py with -a/--add option.\033[0m \033[91m(Example: python ./client -a \"boku no hero academia\":87 where the no. following the ':' refers to the last watched episode number)\033[0m")
